...
class TestActor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.actor = Actor("Test Actor", "test role", self.model_config, self.mock_discussion)

    @patch('app.actor.ChatOllama')
    def test_actor_initialization(self, mock_chat_ollama):
    ...
    def test_get_context_returns_last_five_messages(self):
        ...
        context = self.actor.get_context()
    ...
    def test_get_prompt_format(self):
        ...
        prompt = self.actor.get_prompt("Test message")
    ...
    @patch('app.actor.ChatOllama')
    def test_respond_returns_llm_response(self, mock_chat_ollama):
